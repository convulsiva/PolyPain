...
from infra.client.configs import CacheConfig, ClientConfig, ConfigBox, CookieConfig, NetConfig
...
class GroupIdScraper:
    ...
    def __call__(self, external_id: str) -> GroupIdDTO:
        resp = self._client.request(
            "get", "search/groups", prepare_kwargs={"params": {"q": external_id}}
        )
...
if __name__ == "__main__":
    configs = ConfigBox(
        client=ClientConfig(furl("https://ruz.spbstu.ru/"), "RuzSPbPU"),
        net=NetConfig(),
